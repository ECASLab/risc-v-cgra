...
module tb_local_bus_top;
    ...
    initial begin
        ...
        $monitor("Time: %0dns | Mem_address: %h | Mem_Write_Data: %h | Mem_write: %h | mem_read: %h | result: %h", 
                 $time, global_mem_address, global_mem_write_data, global_mem_write, global_mem_read, result_out);
        ...
        #50
        global_mem_ack = 1;
        global_mem_read_data = 32'd2;
        #10 global_mem_ack = 0;

        #10 global_mem_ack = 1;
        global_mem_read_data = 32'd3;

        #10 global_mem_ack = 0;

        #10 global_mem_ack = 1;
        global_mem_read_data = 32'd4;

        #40

        // Test Case 2: Global memory write operation
        //$display("Test Case 2: Global memory read operation");
