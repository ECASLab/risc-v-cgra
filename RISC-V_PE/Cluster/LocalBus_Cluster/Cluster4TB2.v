...
module local_bus_top_tb;
    ...
    initial begin
        ...
        $display("Time right now is ", $time);

        $display("When sending the global data the time is",$time);

        mem_data_global = 128'b00000000000000001000000000000010_00000000000000001000000000000011_00000000000000001000000000000100_00000000000000001000000000000101;
        mem_ack_global = 4'b1111;

        #10
        mem_ack_global = 4'b0;
        $display("Time after acknowledge is ", $time);
